...
public class MyPoint {
	/*
	 * PATTERN 2-5merのパターン数 すなわちcolumnの数 weight: 重み column: 各2-5merの出現頻度に対応する配列
	 */
	static int PATTERN = (int) Math.pow(4, 2) + (int) Math.pow(4, 3)
	...
	/**
	 * targetの属性を返します。(1 or 0) column[column.length - 2]を返しています。
	 * columnの実装記録が失われているため、 自信はありません。
	 * 
