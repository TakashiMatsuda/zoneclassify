...
//		ZoneExtracter farmer = new ZoneExtracter();
		...
		exa.load(a/*farmer.subZone(100)*/, "Oryzias_latipes.MEDAKA1.53.dna.toplevel.fa");
	}
	...
	public void testInitWeight() {
		...
		ZoneExtracter farmer = new ZoneExtracter();
		DataSet exa = new DataSet();
		exa.load(farmer.subZone(10000), "Oryzias_latipes.MEDAKA1.53.dna.toplevel.fa");// もっと小さいデータでよい
		exa.initWeight();
	}
